...
btnFavorito.textContent = existeFavorito(idMeal)
  ...
  btnFavorito.onclick = function(){
    if (existeFavorito(idMeal)){
        ...
        btnCerrar.favorito.classList.add("btn-danger")
        btnCerrar.favorito.classList.remove("btn-warning")
        mostrarToast("Receta eliminada corretamente")
    }
    agregarFavorito({
        id: idMeal,
        title: strMeal,
    ...
    btnFavorito.textContent = "Borrar Favorito"
    btnCerrar.favorito.classList.add("btn-warning")
    btnCerrar.favorito.classList.remove("btn-danger")
  }
...
function agregarFavorito(){
    ...
    localStorage.setItem
        "recetasFavoritos", JSON.stringify([...favoritos], receta)
    }   
